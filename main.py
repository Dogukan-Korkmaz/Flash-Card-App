...
def create_new_card():
    ...
    canvas.itemconfig(card_word, text=rnd["French"])
...
card_title = canvas.create_text(400, 150, text="", font=("Ariel", 22, "italic"))
card_word = canvas.create_text(400, 263, text="", font=("Ariel", 22, "bold"))
...
button_green = Button(image=button_green_img)
